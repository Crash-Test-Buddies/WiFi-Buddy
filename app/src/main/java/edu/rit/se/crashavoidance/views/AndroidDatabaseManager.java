...
import edu.rit.se.crashavoidance.db.WifiDirectDBHelper;

public class AndroidDatabaseManager extends Activity implements OnItemClickListener {

    // A static class to save cursor, table values etc which is used by functions to share data
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // The main linear layout to which all tables spinners etc will be added.In this activity
        // every element is created dynamically  to avoid using xml file
        ...
        select_table.setOnItemSelectedListener(new OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int pos, long id) {
                ...
                if (pos != 0) {
                    ...
                    // An array adapter which add values to the spinner which helps in user making
                            ...
                            .setPositiveButton("Ok",
                                    new DialogInterface.OnClickListener() {
                                        ...
                                        public void onClick(DialogInterface dialog, int which) {
                                            ...
                                            //if the spinner value is update this row get the values from
                                            ...
                                            //if the spinner value is delete this row get the values from
